...
input_buffer.extend("NOT E T\n")
input_buffer.extend("NOT T T\n")
input_buffer.extend("OR H T\n")
input_buffer.extend("AND T J\n")


input_buffer.extend("RUN\n")
